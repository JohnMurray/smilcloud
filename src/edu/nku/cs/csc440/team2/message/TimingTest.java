...
public class TimingTest extends ActivityInstrumentationTestCase2<HelloAndroid> {
	...
	protected void setUp() throws Exception {
		...
		System.out
				.println("* TimingTest: test setUpClass - create timing containers");
		...
		System.out
				.println("* TimingTest: test setUpClass - create media elements");
		...
		System.out
				.println("* TimingTest: test setUpClass - add elements to containers");
		s1.addElement(t1);
		p1.addElement(i1);
		s2.addElement(a1);
		p2.addElement(v1);
		System.out
				.println("* TimingTest: test setUpClass - add containers to containers");
		s1.addElement(p1);
		p2.addElement(s2);
		System.out
				.println("* TimingTest: test setUpClass - add elements and containers to implicit sequence");
		s.addElement(t2);
		s.addElement(i2);
		s.addElement(s1);
		s.addElement(p2);
	...
	public void testAll() {
		...
		System.out
				.println("* TimingTest: test method 1 - getAllElementIdsCheck()");
		assertEquals("[a1, a2, i1, i2, p1, p2, s1, s2, t1, t2, v1, v2]", s
		...
		// removeElementCheck
		System.out
				.println("* TimingTest: test method 6 - removeElementCheck()");
		...
		assertEquals("[a2, a3, i2, i4, p2, s2, t3, v1, v4]", s
				.getAllElementIds().toString());
