 ...
 * passing data through Intents requires too much overhead or when the data must
...
public class SMILCloud extends Application {
	...
	/**
	 * List of messages that is accessed by the Inbox and the background service
	 * for displaying a user's messages.
	 */
	...
	/**
	 * Retreives the id of a SMIL document. Usually used by SMILPlayer class for
	 * playback.
	 * 
	...
	/**
	 * Retrieves the id of a SMILD document. Usually used by the Composer class
	 * for editing.
	 * 
	 * @return id of a SMIL document
	 */
	 ...
	 * 
	 * @return list of MessageLite objects
	 */
	...
	/**
	 * Store the user id of the currently authenticate user. This can also be
	 * set to the NO_USER value to indicate that no user is currently logged in.
	 * 
	 * @param userID
	...
	/**
	 * Retreive the id of a SMIL document. This is usually used for sharing
	...
	/**
	 * Store an id of a SMIL document. Usually used for sharing messages between
	 * users of the applicatin.
	 * 
	 * @param s
	...
	/**
	 * Store the id of a SMIL document. This is usually used to keep an account
	 * of draft documents, so they can be cleaned up when the document is saved.
	 * 
	 * @param s
	...
	/**
	 * Retrieve the id of a SMIL document. This is usually used by the composer
	 * set of classes for maintaining a clean work-space by automatically
	 * deleting drafts of documents when they are saved.
	 * 
	 * @return the id of a previously previewd (draft) document. It is the id of
	 *         a SMIL document
	 */
