...
/**
 * Abstract player class for objects that do not have children elements.
 * If this were a tree, then you could think of SingleInstancePlayers
 * as leaf nodes.
 * 
 * @author John Murray
 * @version 1.0 4/24/11
...
public abstract class SingleInstancePlayer extends Player 
{
	...
	/**
	 * Start/continue playing the media element and render it if 
