...
public class Arbiter 
{
	...
	/**
	 * Contains the root object of the Player. This is what all 
	...
	/**
	 * A counter for the progress that the document has played back
	 * so far. 
	 */
	private double totalPlaybackTime = 0.0;
	/**
	 * Boolean to tell if the document is paused (or if a Player object
	 * should be pausing).
	 */
	...
	/**
	 * Call play on the root element, should cascade down
	...
	/**
	 * Let the arbiter know that you are buffering so that
	 * the other Player objects know what they should be doing.
	 * 
	 * @note Implementation of what the other Player objects should
	 * do at this time is independend of the Arbiter.
	 */
	 ...
	 * @return
	 * 			The current progress of the document playback
	 */
