...
/**
 * Is a ContainerPlayer that allows the simultaneous playback of multiple Player
 * objects.
 * 
 * @author John Murray
 * @version 1.0 4/24/11
...
public class ParPlayer extends ContainerPlayer {
	...
	/**
	 * Play each component that should be playing at this particular instance.
	 * Also unrender any objects that are done playing.
	 */
	public void play() {
	...
	/**
	 * Get the duraction of all of the components and cache them. Return the
	 * cache if one has already been generated.
	 */
	@Override
